...
(
  ...
  from_city INTEGER REFERENCES city.city_name,
  from_country INTEGER REFERENCES city.country_id,
  to_city INTEGER REFERENCES city.city_name,
  to_country INTEGER REFERENCES city.country_id,
);
...
VALUES
  ...
  ('Jennifer', 'Finch', '20A', '2018-04-15 16:50:00', '2018-04-15 21:00:00', 3, 2, 1, 8, 4),
  ('Waneta', 'Skeleton', '23D', '2018-08-01 18:30:00', '2018-08-01 21:50:00', 4, 9, 5, 10, 6),
  ...
  ('Alvin', 'Leathes', '1A', '2018-12-22 14:42:00', '2018-12-22 15:56:00', 6, 15, 1, 16, 1),
  ('Berkie', 'Wycliff', '32B', '2019-02-06 16:28:00', '2019-02-06 19:18:00', 6, 14, 1, 17, 1),
  ('Cory', 'Squibbes', '10D', '2019-01-20 19:30:00', '2019-01-20 22:45:00', 7, 18, 9, 19, 10);
